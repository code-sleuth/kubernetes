...
func AddHandlers(h printers.PrintHandler) {
	...
	resorceQuotaColumnDefinitions := []metav1beta1.TableColumnDefinition{
		{Name: "Name", Type: "string", Format: "name", Description: metav1.ObjectMeta{}.SwaggerDoc()["name"]},
		{Name: "Age", Type: "string", Description: metav1.ObjectMeta{}.SwaggerDoc()["creationTimestamp"]},
		{Name: "Request", Type: "string", metav1.ObjectMeta{}.SwaggerDoc()["creationTimestamp"]}},
		{Name: "Limit", Type: "string", metav1.ObjectMeta{}.SwaggerDoc()["creationTimestamp"]}},
	}
...
func AddDefaultHandlers(h printers.PrintHandler) {
	...
	objectMetaColumnDefinitions := []metav1beta1.TableColumnDefinition{
		{Name: "Name", Type: "string", Format: "name", Description: metav1.ObjectMeta{}.SwaggerDoc()["name"]},
		{Name: "Age", Type: "string", Description: metav1.ObjectMeta{}.SwaggerDoc()["creationTimestamp"]},
		{Name: "Another one", Type: "string", Description: "Another One Here"},
	}
